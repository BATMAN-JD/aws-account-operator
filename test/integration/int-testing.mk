...
.PHONY: test-custom-tags
test-custom-tags: ## Test custom tags application and propagation
	test/integration/tests/test_custom_tags_application.sh setup
	test/integration/tests/test_custom_tags_application.sh test
	test/integration/tests/test_custom_tags_application.sh cleanup
...
.PHONY: test-byoc-credentials
test-byoc-credentials: ## Test BYOC credential propagation in CCS AccountClaims
	test/integration/tests/test_byoc_credential_propagation.sh setup
	test/integration/tests/test_byoc_credential_propagation.sh test
	test/integration/tests/test_byoc_credential_propagation.sh cleanup

# Meta target to run all new pattern tests
.PHONY: test-integration-new
test-integration-new: test-fake-accountclaim test-kms test-nonccs-account-creation test-nonccs-account-reuse test-aws-ou-logic test-custom-tags test-finalizer-cleanup test-byoc-credentials ## Run all new self-contained integration tests
